...
@dso_cache = dso_local local_unnamed_addr global [56 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libcrypto.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libqpdf.so
		ptr null; void* handle
	}, ; 15
	%struct.DSOCacheEntry {
...
@.DSOCacheEntry.12_name = private unnamed_addr constant [13 x i8] c"libcrypto.so\00", align 1
@.DSOCacheEntry.13_name = private unnamed_addr constant [11 x i8] c"libqpdf.so\00", align 1
